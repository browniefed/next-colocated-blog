export const meta = {
    title: "Create a Dropdown in React that Closes When the Body is Clicked",
    description: "In this lesson we'll create a dropdown menu that is toggle via a button setting state. We'll then setup a ref to get access to the container div. Finally using event listeners on the document body we will check if the user clicked anywhere outside of our dropdown and then close the dropdown.",
    createdAt: "2018-12-21T18:30:26.682+00:00"
};
