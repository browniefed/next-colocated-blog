export const meta = {
    title: "Creating a Reusable Window Event Listener Hook with useEffect and useCallback",
    description: "In this lesson we'll dive into issues with creating class components for reusable logic. Then we'll convert the logic to take advantage of hooks. We'll step through each pitfall that could be encountered and how to solve them. We'll end up with a perfect solution and understanding for how to combine multiple hooks like `useEffect` and `useCallback`.",
    createdAt: "2019-03-06T19:13:46.369+00:00"
};
...
https://codesandbox.io/s/jplmpv2v85