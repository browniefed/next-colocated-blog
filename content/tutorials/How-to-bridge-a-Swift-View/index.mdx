export const meta = {
    title: "How to bridge a Swift View",
    description: "",
    createdAt: "2015-11-28T00:41:22.213302+00:00"
};
...
![](http://i.imgur.com/fcBMyIS.png)

Then we'll subclass it off of `RCTView`

![](https://i.imgur.com/57Vcf0j.png)
