export const meta = {
    title: "Create the James Bond Introduction in CSS and React",
    description: "In this lesson we'll explore the concept of transitions and animations. We'll create circles that span the width of the screen. Then using transitions create a circle that moves at a linear pace across the screen. Finally using animation and animation delays we'll stagger the appearance and disappearance of each circle.",
    createdAt: "2019-01-22T19:24:10.009+00:00"
};
