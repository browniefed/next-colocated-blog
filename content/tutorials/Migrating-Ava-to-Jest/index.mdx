export const meta = {
    ...
    description: "Migrating from Ava to Jest",
    createdAt: "2016-10-06T00:38:15.327243+00:00"
};
...
There is hopefully more coming but go use Jest, star the repo on git [https://github.com/facebook/jest](https://github.com/facebook/jest) and never look back.uses Webpack `root` property to use shared code across 2 directories in a monorepo. Adding that in other testing libraries required webpack and other NPM installed libraries.
 In Jest it is as simple as adding this to your config.
