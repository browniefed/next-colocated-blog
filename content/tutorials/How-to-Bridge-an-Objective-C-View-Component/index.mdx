export const meta = {
    title: "How to Bridge an Objective-C View Component",
    description: "",
    createdAt: "2015-11-24T00:42:27.749189+00:00"
};
...
![](https://i.imgur.com/AfCMdHF.png)

Then do this

![](https://i.imgur.com/BySd9oD.png)
...
![](https://i.imgur.com/jEQdrce.png)

We need to add our new manager files to our compile source.

![](https://i.imgur.com/6Kzve8u.png)
