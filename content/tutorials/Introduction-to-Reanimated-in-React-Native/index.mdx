export const meta = {
    title: "Introduction to Reanimated in React Native",
    description: "In this lesson we'll explore using Reanimated and React Native Gesture Handler to create a button using `TapGestureHandler`. With declarative animations in Reanimated we'll use `cond`, and `eq` to create a purely native opacity change animation when the button is pressed.",
    createdAt: "2018-07-18T03:36:48.832+00:00"
};
