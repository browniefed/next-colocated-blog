export const meta = {
    title: "Create a Custom Animated Bottom Action Sheet without Measuring in React Native",
    description: "We'll explore how we can create a custom action sheet in React Native that will animate visible/hidden without measuring any of the views. The technique will use absolute positioning, translation, and interpolation. The backdrop will quickly animate upwards before fading in. We'll position the action sheet container off screen, then translate the action action sheet on the screen. This allows us to not have to measure any of the inner content.",
    createdAt: "2018-12-23T20:32:59.978+00:00"
};
