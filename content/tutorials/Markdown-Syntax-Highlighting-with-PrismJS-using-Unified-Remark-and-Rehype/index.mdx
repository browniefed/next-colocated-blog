export const meta = {
    title: "Markdown Syntax Highlighting with PrismJS using Unified, Remark, and Rehype",
    description: "We'll explore how to use Unified, Remark, Rehype, and PrismJS to create markdown code that is capable of being syntax highlighted. The generated code will be React elements instead of a string of HTML. This adds in the security benefits of React when it comes to rendering untrusted markdown content.",
    createdAt: "2019-07-04T20:14:58.596+00:00"
};
