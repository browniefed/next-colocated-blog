export const meta = {
    title: "Create a Snapping Image Swiper like Instagram with React",
    description: "In this lesson we're going to build an image swiper that works on web and mobile. We'll use a similar technique to Instagram and create a div that hides all overflow and translate an inner container left/right. We'll add in the ability to detect what image the user is looking at and snap to that image.",
    createdAt: "2019-01-07T02:52:05.527+00:00"
};
