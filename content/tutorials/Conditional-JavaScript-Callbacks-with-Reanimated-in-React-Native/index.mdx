export const meta = {
    title: "Conditional JavaScript Callbacks with Reanimated in React Native",
    description: "In this lesson we'll explore how to setup a draggable circle. Then we'll dive into using the `call` method to create JavaScript callbacks whenever certain conditions are met inside of Reanimated.",
    createdAt: "2018-08-06T02:06:39.861+00:00"
};
