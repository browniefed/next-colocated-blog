export const meta = {
    title: "Create a Hoverable Display Card with React and Emotion",
    description: "In this lesson we'll explore how to get Emotion setup with create-react-app. Then dive into using `@emotion/styled` to create styled React components. Finally we'll show how to structure styled components to allow you to use `:hover` and `transition` to create animated hover effects.",
    createdAt: "2018-12-20T19:08:11.092+00:00"
};
