export const meta = {
    title: "Prevent Navigation with the React Router Prompt Component When Data is Being Edited",
    description: "In this lesson we'll show how to setup the Prompt component from React Router. We'll prompt with a static message, as well as a dynamic method with the message as a function. Finally we'll show that you can return `true` from the message as a function to dynamically allow navigation.",
    createdAt: "2018-04-02T15:44:51.732+00:00"
};
