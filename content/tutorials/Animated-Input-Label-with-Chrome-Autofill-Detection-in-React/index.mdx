export const meta = {
    title: "Animated Input Label with Chrome Autofill Detection in React",
    description: "In this lesson we'll create a label that is centered inside of a text input. We'll look at how to detect Chrome is autofilling the input using CSS animation and CSS pseudo classes. When the input is autofilled, focused, or filled in we show how to animate the label to it's resting place a top the input.",
    createdAt: "2019-01-15T16:48:01.31+00:00"
};
