export const meta = {
    title: "Add Undo Abilities to any Application Easily with Immer and React",
    description: "Undo capabilities can be complicated to add to any application. We'll dive into how we can use the Immer library to lend us a hand in managing our state and making undo easy.",
    createdAt: "2019-03-08T20:04:08.661+00:00"
};
