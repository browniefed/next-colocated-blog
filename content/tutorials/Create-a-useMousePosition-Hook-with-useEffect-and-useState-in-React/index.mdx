export const meta = {
    title: "Create a useMousePosition Hook with useEffect and useState in React",
    description: "In this lesson we'll explore how to combine `useEffect` with `useState` to create a reusable hook. It will listen add a window listener for `mousemove` and update state with each movement.",
    createdAt: "2018-11-21T03:10:41.343+00:00"
};
